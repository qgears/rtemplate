 ...
 * 
 * A deferred template can only be executed once. When executed multiple times it returns empty string.
 * This feature can be used in a way to execute a deferred template part at a specific point of template generation (eg. at the end of a block).
 * 
 * @author rizsi
 *
 */
abstract public class DeferredTemplate extends RAbstractTemplatePart
{
	...
	private int offset;
	/**
	 * This template has once been executed. Do not execute it again.
	 */
	 ...
	 * * Marks this deferred template part to be executed. On further execution nothing is done.
	 */
